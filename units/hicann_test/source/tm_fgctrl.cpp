...
class TmFgCtrl : public Testmode, public RamTestIntfUint {
protected:
	virtual string ClassName() {stringstream ss; ss << "tm_fgctrl"; return ss.str();}
public:
...
class LteeTmFgCtrl : public Listee<Testmode>{
public:
	LteeTmFgCtrl() : Listee<Testmode>(string("tm_fgctrl"), string("test floating-gate stuff")){};
	Testmode * create(){return new TmFgCtrl();};
};

LteeTmFgCtrl ListeeTmFgCtrl;
