...
class TmPLLTestAG : public Testmode{
...
//				cout << "read jtag bypass: 0x" << hex << veri << endl;
			...
			case '7':{
				...
				jtag->HICANN_set_test_ctrl(0x1);
				jtag->HICANN_set_test_ctrl(0x0);
        ...
        jtag->HICANN_arq_write_ctrl(ARQ_CTRL_LOOPBACK, ARQ_CTRL_LOOPBACK);
			...
			case '9': {
				...
				jtag->set_jtag_instr(CMD_SYSTEM_ENABLE);
...
class LteeTmPLLTestAG : public Listee<Testmode>{
public:
	LteeTmPLLTestAG() : Listee<Testmode>(string("tmag_plltest"),string("configure and test Faraday PLL")){};
	Testmode * create(){return new TmPLLTestAG();};
};

LteeTmPLLTestAG ListeeTmPLLTestAG;
