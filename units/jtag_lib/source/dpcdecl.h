...
const DWORD cchErcMax = 48;       // maximum length of error code symbolic name
...
const ERC ercCapabilityConflict =
	3; //  Tried to enable capabilities that use shared resources, check device datasheet
...
const ERC ercTransferPending = 1031;  //  The last API called in overlapped mode was not finished.
									  //  Use DmgrGetTransStat or DmgrCancelTrans
...
const ERC ercInsufficientResources =
	3078; //  Memory allocation failed, insufficient system resources
const ERC ercInvalidTFP =
	3079; //  Internal protocol error, DVT rejected the transfer strcuture sent by public API
...
const ERC ercEnumNotFree =
	3084; //  Device Enumeration failed because another enumeration is still running.
