...
// DmgrGetLastError returns the last error per process which is updated when a DVC API function
// fails.
...
DPCAPI BOOL
DmgrEnumDevicesEx(int* pcdvc, DTP dtpTable, DTP dtpDisc, DINFO dinfoSel, void* pInfoSel);
