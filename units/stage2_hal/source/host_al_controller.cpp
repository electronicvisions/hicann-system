...
void HostALController::setARQStream(sctrltp::ARQStream<sctrltp::ParametersFcpBss1> *set_arq)
{
	this->arq_ptr = set_arq;
}

sctrltp::ARQStream<sctrltp::ParametersFcpBss1> *HostALController::getARQStream()
{
	return this->arq_ptr;
}
...
sctrltp::packet<sctrltp::ParametersFcpBss1> HostALController::getReceivedJTAGData()
{
...
bool HostALController::sendFPGAPlayback(std::vector<uint32_t>& payload, double timeout)
{
	...
	unsigned int max_frame = 2 * sctrltp::ParametersFcpBss1::MAX_PDUWORDS;
...
{
	unsigned int max_config_per_frame = sctrltp::ParametersFcpBss1::MAX_PDUWORDS;
